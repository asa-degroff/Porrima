...
export function computeContextBreakdown(chat: Chat, contextWindow: number): ContextBreakdown {
  ...
  const inputRows: ContextBreakdownRow[] = [
    ...
    { key: "retrievedMemories", label: "Frozen memories", group: "memory", tokens: retrievedMemories },
    { key: "memoryDelta", label: "Memory additions", group: "memory", tokens: memoryDelta },
