...
export function resolveRetrievalBudget(settings: Settings): RetrievalBudget {
  ...
  return {
    ...
    passiveRecall: {
      ...
      rerankQueryChars: clampInt(settings.passiveRecallRerankQueryChars, base.passiveRecall.rerankQueryChars, 400, 2000),
