      ...
      >
        ...
        >
          ...
          <div ref={buttonsRef} className="float-right clear-right flex items-center gap-2 ml-2">
            ...
            {streaming && canSend ? (
              ...
              <button
                ...
                data-haptic="manual"
                className="relative depth-raised px-4 py-1.5 rounded-lg bg-red-500/20 border border-red-400/30 text-red-300 text-sm hover:bg-red-500/30 transition-colors pressable"
              >
                Stop
              </button>
            ) : !isOnline ? (
              <button
                ...
                disabled={!canSend}
                data-haptic="manual"
                className="relative depth-raised px-4 py-1.5 rounded-lg bg-amber-500/20 border border-amber-400/30 text-amber-300 text-sm hover:bg-amber-500/30 transition-colors disabled:opacity-30 disabled:cursor-not-allowed inline-flex items-center gap-1.5 pressable"
          ...
          <div
            ...
            onPaste={handlePaste}
            className="min-h-8 py-1.5 outline-none text-white/90 text-sm leading-relaxed break-words whitespace-pre-wrap"
          ...
          {!hasContent && images.length === 0 && (
            <div className="absolute top-1.5 left-0 pointer-events-none text-white/30 text-sm leading-relaxed select-none">
