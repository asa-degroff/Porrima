...
function getToolIcon(name: string): ToolIconName {
  const svgTools: Record<string, ToolIconName> = {
    ...
    list_memory_blocks: "list_memory_blocks",
    read_memory_block: "read_memory_block",
    create_memory_block: "create_memory_block",
    update_memory_block: "update_memory_block",
    read_archived_context: "read_archived_context",
    create_notebook_entry: "create_notebook_entry",
    ask_user: "ask_user",
    schedule_reminder: "schedule_reminder",
    list_automations: "list_automations",
    update_automation: "update_automation",
    schedule_chat_message: "schedule_chat_message",
    web_fetch: "web_fetch",
